...
<nav class="bg-green-600 text-white shadow-md">
    <div class="container mx-auto flex items-center justify-between p-4">
        ...
        <div class="hidden md:flex space-x-4 relative" id="navbar">
            ...
            <a href="./buah_kami.php" class="hover:underline">Buah Kami</a>
    ...
    <div class="md:hidden hidden flex-col space-y-2 p-4" id="mobileMenu">
        ...
        <a href="./buah_kami.php" class="block text-center bg-white text-green-600 py-2 rounded">Buah Kami</a>
        ...
        <a href="./login.php" class="block text-center bg-white text-green-600 py-2 rounded">Masuk</a>
    </div>
</nav>
